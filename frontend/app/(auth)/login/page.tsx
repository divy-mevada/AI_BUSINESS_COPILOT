...
export default function LoginPage() {
  ...
  return (
    <section className="flex-1 flex flex-col justify-center bg-surface px-margin-mobile md:px-margin-desktop py-12">
      <div className="max-w-md w-full mx-auto animate-fade-in-down">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link
                className="text-[12px] leading-[16px] font-semibold text-secondary hover:text-primary transition-colors"
                href="#"
              >
                Forgot Password?
              </Link>
        ...
        <div className="grid grid-cols-2 gap-4 mb-10">
          <div className="relative flex items-center justify-center">
            <button className="w-full flex items-center justify-center gap-2 border border-outline-variant bg-surface-container-lowest py-3 rounded-lg hover:bg-surface-container-low transition-colors group cursor-pointer text-on-surface">
              <svg
            ...
            <div className="absolute inset-0 opacity-0 overflow-hidden cursor-pointer z-20 w-full h-full [&_iframe]:w-full [&_iframe]:h-full [&_iframe]:cursor-pointer [&_iframe]:absolute [&_iframe]:top-0 [&_iframe]:left-0 [&_iframe]:opacity-0">
              <GoogleLogin
